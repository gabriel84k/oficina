        ...
        <v-container fluid >
            <v-card>
                <v-toolbar class="sau-dataTable__title white--text" dark>
                    ...
                    <nuevo v-if="permiso.nuevo" :user="{}" :tipo="'Nuevo'" :view="view" @refresh="toUpdate"></nuevo>
                </v-toolbar>
                            ...
                            <vuetable ref="vuetable"
                                    ...
                                    <template slot="accion" slot-scope="props">
                                        ...
                                        <div class="row text-center" >
                                            <nuevo v-if="permiso.modificar" :tipo="'Modificando'" :user="props.rowData"  @refresh="toUpdate"  :isrt="isroot" :view="view"></nuevo>
                                            <v-btn
                                                v-if="true"
                                                class="mx-2" 
                                                fab  
